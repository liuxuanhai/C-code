// 加入winmm.lib才能使用MCI函数
// (Media Control Interface, MCI)媒体控制接口, 这个可以控制多媒体PC中的所有多媒体硬件;
// 比如直接控制CD驱动设备然后播放CD音频
#include <windows.h> 
#include "p980MCI的学习和测试.h" 
#define ID_TIMER  1 
...
{ 
	...
	case    WM_INITDIALOG: 
		...
		SetWindowPos (hwnd, NULL, (GetSystemMetrics  (SM_CXSCREEN)  -  rect.right  +  rect.left)  /  2, (GetSystemMetrics  (SM_CYSCREEN)  -  rect.bottom  +  rect.top)  /  2, 0, 0, SWP_NOZORDER | SWP_NOSIZE) ; 

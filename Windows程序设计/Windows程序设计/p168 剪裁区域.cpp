...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SIZE:
		...
		CombineRgn(hRgnTemp[4], hRgnTemp[0], hRgnTemp[1], RGN_OR);  // 左右两边的椭圆全部合并
		CombineRgn(hRgnTemp[5], hRgnTemp[2], hRgnTemp[3], RGN_OR);	// 上下两边的椭圆全部合并
	...
	case WM_PAINT:
		...
		fRadius = _hypot(cxClient / 2.0, cyClient / 2.0);  // math.h 求直角三角的斜边值;
